...
// Function Declarations
	...
	// URL Parameters from after the hash "#"
...
//        alert("setApiKey('"+key+"') called");
	...
	function updateFeeds(feedId, datastreamIds, duration, interval) {
		xively.feed.get(feedId, function(feedData) {
            ...
            console.log('Datastream downloaded, closing "loading" panel.');
	...
	function setFeeds(feeds) {
		...
		feeds.forEach(function(id) {
            ...
            if( foundFeedIds[thisFeedId] ) {
                alert("Feed id: "+thisFeedId+" is specified more than once\n\nDon't specify more than one feed id.\n\nIf you want multiple datastreams from a single feed id,\nUse the notation "+thisFeedId+"!dataStream_A!dataStream_B...");
                return;
            }

            foundFeedIds[thisFeedId] = true;
