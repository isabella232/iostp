...
Rickshaw.Graph.JSONP=Rickshaw.Class.create(Rickshaw.Graph.Ajax,{
    request:function(){
        $.ajax({
            url:this.dataURL,dataType:"jsonp",success:this.success.bind(this),error:this.error.bind(this)
        })
    }
});
...
Rickshaw.Graph.Renderer=Rickshaw.Class.create({
    ...
    render:function(){
        var graph=this.graph;graph.vis.selectAll("*").remove();
